...
function UPstorage() {
  ...
  let arraystring = JSON.stringify(busMall.allBusMall);
  console.log(busMall.allBusMall);
  console.log(arraystring);
  localStorage.setItem('busMall', arraystring);
}
function getBusMall() {

  let dataOfBusMall = localStorage.getItem('busMall');
  console.log(dataOfBusMall);
  let busMallData = JSON.parse(dataOfBusMall);

  if (busMallData !== null) {
    busMall.allBusMall = busMallData;
  }
  renderImages();
